        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-md-3">
                    ...
                    <div class="footer-underline"></div>
                    <div class="mb-2"><a href="{{ route('frontend.category') }}" class="text-white">Kategoriler</a>
                    </div>
                    <div class="mb-2"><a href="{{ route('frontend.home') }}" class="text-white">Trend Ürünler</a></div>
                    <div class="mb-2"><a href="{{ route('frontend.products.newArrival') }}" class="text-white">Yeni
                            Gelen
                            Ürünler</a></div>

                    ...
                    <div class="shadow bg-white p-3">
                        ...
                        <div class="row">
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="text" id="full_name" wire:model="full_name" class="form-control" placeholder="Lütfen İsim Soyisim Giriniz."/>
                                @error('full_name') <small class="text-danger">{{ $message}}</small> @enderror
                            </div>
                            <div class="col-md-6 mb-3">
                                <label for="phone">Telefon Numarası <small class="text-danger">*</small></label>
                                <input type="text" id="phone" wire:model="phone" class="form-control" placeholder="Lütfen Telefon Numarasını Giriniz."/>
                                @error('phone') <small class="text-danger">{{ $message}}</small> @enderror
                            </div>
                            <div class="col-md-6 mb-3">
                                <label for="email">E-mail <small class="text-danger">*</small></label>
                                <input type="email" id="email" wire:model="email" class="form-control" placeholder="Lütfen E-mail Giriniz."/>
                                @error('email') <small class="text-danger">{{ $message}}</small> @enderror
                            </div>
                            <div class="col-md-6 mb-3">
                                <label for="province">İl <small class="text-danger">*</small></label>
                                <input type="text" id="province" wire:model="province" class="form-control" placeholder="Lütfen İl Giriniz."/>
                            ...
                            <div class="col-md-12 mb-3">
                                ...
                                <input type="text" id="county" wire:model="county" class="form-control" placeholder="Lütfen İlçe Giriniz."/>
                                @error('county') <small class="text-danger">{{ $message}}</small> @enderror
                            </div>
                            <div class="col-md-12 mb-3">
                                <label for="address">Adres <small class="text-danger">*</small></label>
                                <textarea id="address" wire:model="address" class="form-control" placeholder="Lütfen Adres Giriniz."></textarea>
                        ...
                        <div class="shadow bg-white p-3">
                            ...
                            @foreach($cartItems as $cart)
                                ...
                                <div style="display: flex;flex-direction: row; justify-content: space-between;">
                                    <img src="{{ asset($cart->products->productImages[0]->image) }}" width="50px" height="50px">
                                    ...
                                    <button type="button" wire:click="removeCart({{ $cart->id }})" class="btn btn-sm btn-danger" style="width: 50px">Sil</button>
                                </div>
